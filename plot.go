//Package plot implements the plotting functionality and statistical operations about the data
package plot
...
func PlotGaussian(mean, stddev float64) error {
	var points []point
	for i := 0.0; i < 2.0; i += 1 / (10000.0) {
		p := point{
			x: i,
